...
if ($nama_rs != $data['nama_rs']) {
	if ($password == $password2) {
		$sql="INSERT INTO rumah_sakit (id, nama_rs, password, profil_rs, no_tlpn_rs, alamat, link_gmaps, jumlah_ambulan, namaimg, ukuranimg, tipe) VALUES ('', '$nama_rs', '$password', '$profil', '$no_tlpn_rs', '$alamat', '$link_gmaps', '$jumlah_ambulan', 'rsdefault.jpg', '', '')";
